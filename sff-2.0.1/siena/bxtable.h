...
//
#ifndef SIENA_BXTABLE_H_INCLUDED
#define SIENA_BXTABLE_H_INCLUDED
 ...
 **/
class BXTable : public AttributesFIB {
public:
    /** @brief create and initialize a BXTable.
     **/
    static BXTable * create();
};
