...
do
  ...
  test_description "Testing repeated constructions of the forwarding table ($n/$num)..."
  $SFF < $in > $out
  n=`expr $n + 1`
...
test_description "Tested repeated constructions of the forwarding table..."
test_passed
